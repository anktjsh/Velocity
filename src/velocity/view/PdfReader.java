...
// * @author Aniket
// */
//public class PdfReader extends BorderPane {
//
//    public PdfReader(File f) {
//        BaseViewer fa;
//        setCenter(fa = new BaseViewer());
//        fa.loadPDF(f);
//    }
//
//    private enum FitToPage {
//
//        AUTO, WIDTH, HEIGHT, NONE
//    }
//
//    private class BaseViewer extends BorderPane {
//
...
//
//        /**
//         * take a File handle to PDF file on local filesystem and displays in
//         * PDF viewer
//         *
...
//
//                        /**
//                         * See if there's a JVM flag for the password & Use it
//                         * if there is Otherwise prompt the user to enter a
//                         * password
//                         */
...
//         *
//         * If the user does not enter the correct password it will ask them to
//         * try again. If the user presses the Cross button, the password prompt
//         * will close.
//         *
//         * @param passwordCount is an int which represents the current input
//         * attempt
//         */
...
//         * @return int
//         */
//        private int findClosestIndex(final float scale, final float[] scalings) {
