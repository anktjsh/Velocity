...
//    private static final HashMap<VelocityEngine, List<WebEntry>> map = new HashMap<>();
...
//import javafx.beans.property.SimpleObjectProperty;
//import javafx.collections.ListChangeListener;
//import javafx.scene.web.VelocityEngine;
...
//    private class HistoryChangeListener implements ListChangeListener<Entry> {
//
//        private final VelocityEngine web;
//
//        public HistoryChangeListener(VelocityEngine eng) {
//            web = eng;
//        }
//
//        @Override
...
//    }
//
//    public List<WebEntry> getHistory(VelocityEngine web) {
//        return map.get(web);
//    }
//
